...
#show: slides.with(
  title: "CS304 Project Sprint 1 Report", // Required
...
#figure(
  image("assets/diagram.png", height: 90%)
)
...
#figure(image("assets/homepage.png", height: 90%))

== Class

#figure(image("assets/class.png", height: 90%))

== Feedback

#figure(image("assets/feedback.png", height: 90%))

== PDF mark

#figure(image("assets/pdf_mark.png", height: 90%))

== Argue

#figure(image("assets/argue.png", height: 90%))

== Argue plaza

#figure(image("assets/plaza.png", height: 90%))

= Process & Collaborations

== Collaborations

- Github:  #link("https://github.com/sustech-cs304/team-project-25spring-12/")
